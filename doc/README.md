...
9. [`optimization-qa.md`](optimization-qa.md)
...
| [`optimization-qa.md`](optimization-qa.md) | 站在产品 / 架构 / 答辩视角做的一轮自问自答式优化建议 |
...
- [`../docs/mpc_skill_guide.md`](../docs/mpc_skill_guide.md)：MPC Skill 接入指导
- [`../DEVELOPMENT_HISTORY.md`](../DEVELOPMENT_HISTORY.md)：根目录续会话上下文文件

## 为什么保留两份“开发历史”

- `doc/development-history.md`：给 GitHub 网页阅读，偏展示与归档
- 根目录 `DEVELOPMENT_HISTORY.md`：给后续 Codex / 新会话快速读取，偏上下文续接与节省 token
